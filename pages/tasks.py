...
/* Desktop: sem scroll no body — o board gerencia internamente */
html,body{{height:100%;overflow:hidden;background:#fff;}}

/* Tablet e mobile: body scrollável, altura automática */
@media (max-width:900px){{
  html,body{{
    height:auto !important;
...
@media (max-width:900px){{
  ...
  /* Board: scroll horizontal entre colunas, altura automática */
  .board{{
    gap:6px;
    padding:6px;
    margin-top:44px;
    ...
    /* Mostra scrollbar horizontal */
    -webkit-overflow-scrolling:touch;
  }}
  /* Cada coluna tem altura própria com scroll interno de cards */
  .col{{
    min-width:260px;
...
@media (max-width:600px){{
  ...
  /* Board: coluna vertical, scroll pelo body da página */
  .board{{
  ...
  /* Cada coluna ocupa largura total, altura automática */
  .col{{
    flex:none !important;
